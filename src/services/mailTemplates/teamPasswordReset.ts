...
export default function teamPasswordReset(name: string, email: string, password: string, workspace: string, workspaceId: string) {
    ...
    <html lang="en" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:v="urn:schemas-microsoft-com:vml">
        ...
        <body style="background-color: #FFFFFF; margin: 0; padding: 2px; -webkit-text-size-adjust: none; text-size-adjust: none;">
            ...
            <p style="margin-bottom:10px;"> 
                Your Password has been resetted in ${workspace} workspace
            </p>
