...
const LoadingButtonSM = (props: IProps) => {
    ...
    if (loading) return (
        <button 
            onClick={onClick} 
            disabled={true}
            className={`flex justify-center rounded-lg w-full bg-gray-400 disabled:bg-gray-400 disabled:text-gray-200 py-2 px-6 ${props.className}`}> 
            <Oval
                height={18}
                width={18}
                color="#ffffff"
        ...
        case "yellow":
            return (
                <button 
                    onClick={onClick}
                    disabled={disabled}
                    className="rounded-lg w-full bg-yellow-600 hover:bg-yellow-700 py-2 px-6 text-white disabled:bg-gray-400 disabled:hover:bg-gray-400 disabled:text-gray-200"> 
                    {children}
                </button>
            )
        default:
