  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.data.status === 'success') {
        ...
        router.push('/dashboard/leadgen/forms');
      }
    } catch (error: any) {
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Build a custom form to capture leads</p>
      </div>
...
export default function CreateFormPage(props: IProps) {
  const user = JSON.parse(props.user);
  return (
